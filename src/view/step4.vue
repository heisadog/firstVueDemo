...
<div class="yd-flexview">
    <div class="g-scrollview">
      <search @ongetdata ='getsort' @onsearch = 'searchfn'  :idx='4'></search>
      <!-- 页签 -->
    ...
    <div class="m-button">
        <span class="m-but-master" @click="showContent">后整</span>
    </div>
...
export default {
    ...
    mounted(){
        ...
        // if(!this.$store.state.status.step4sta || this.$store.state.step4json.length == 0 || this.$store.state.backReload || this.$store.state.status.stepallsta) this.getdata()
        // else this.list = (this.$store.state.step4json)
        this.getdata()
    },
    methods:{
        ...
        getdata:function(){
            ...
            vOpr1Data.setValue("AS_OPRFLAG",'4' );//1 2 3 4 5 底部标签
            ...
            ip.invoke(function(d){
                if ((d.iswholeSuccess == "Y" || d.isAllBussSuccess == "Y")) {
                    ...
                    //更新数据和状态
                    _this.$store.commit('ipdatestep4',AC_HEAD); 
                     //单次数据请求结束
        ...
        goDetail:function(id,mainid,orderid){
            console.log(id);
            this.$router.push({path:'/stepdtl',query:{id:id,footId:'3',mainid:mainid,orderid:orderid}})//this.$route.path
        },
        //显示填写数量和备注界面
