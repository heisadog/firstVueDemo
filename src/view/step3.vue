...
<div class="yd-flexview">
    <div class="g-scrollview">
      <search @ongetdata ='getsort' @onsearch = 'searchfn'  :idx='3'></search>
      <!-- 页签 -->
...
export default {
    ...
    methods:{
           ...
           vOpr1Data.setValue("AS_CONDITION",_this.searchKey);//input的搜索 供应商等
            ...
            ip.invoke(function(d){
                if ((d.iswholeSuccess == "Y" || d.isAllBussSuccess == "Y")) {
                    ...
                    //更新数据和状态
                    _this.$store.commit('ipdatestep3',AC_HEAD); 
                     //单次数据请求结束
        ...
        goDetail:function(id,mainid,orderid){
            console.log(id);
            this.$router.push({path:'/stepdtl',query:{id:id,footId:'2',mainid:mainid,orderid:orderid}})//this.$route.path
        },
        loadLists(){
            console.log('滚动加载了')
            this.pageno ++;
